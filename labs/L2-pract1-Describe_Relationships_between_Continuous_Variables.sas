...
Another option for determining the interquartile range 
is to include the keyword QRANGE in the list of statistics specified 
in the PROC MEANS statement. 
That way SAS will calculate this statistic for you.
 */